...
[![Java](https://img.shields.io/badge/Java-17-orange)](https://github.com/easy-4-java/shiro-weixin) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)
...
```groovy
implementation 'io.github.easy4j:shiro-weixin-spring:2.0.x.20260630-SNAPSHOT'
```
...
维护策略：`1.0.x` 为当前活跃开发线（当前快照 `2.0.x.20260630-SNAPSHOT`）；`2.0.x` 与 `3.0.x` 为面向更新 JDK 的前向移植线。快照按需构建，正式 Release 通过 GitHub Releases 分发。
